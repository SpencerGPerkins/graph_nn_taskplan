...
with open("../docs/graphSAGE_testing_results_0324.json", "r") as f:
...
plt.savefig("../docs/GraphSAGE_test_4class_confmat_0324.png")
plt.show()
...
# Save to CSV
df.to_csv("../docs/GraphSAGE_test_report_0324.csv", index=True)